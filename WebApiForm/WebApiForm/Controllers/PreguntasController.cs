    ...
    public class PreguntasController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeletePregunta(int id)
        {
            ...
            catch (DbUpdateException dbEx)
            {
                ...
                {
                    return BadRequest(new { message = "Esta pregunta esta siendo utilizado en la tabla Sesion. SI quieres eliminarlo deberas de borrarlo primero en la tabla de Sesion" });
                }
