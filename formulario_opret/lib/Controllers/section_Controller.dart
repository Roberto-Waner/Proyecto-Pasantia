...
class SectionController {
  ...
  final ApiServiceSesion2 _apiServiceSesion2 = ApiServiceSesion2('https://192.168.1.9:7190');
  final StreamServices _streamServices = StreamServices('https://192.168.1.9:7190');
