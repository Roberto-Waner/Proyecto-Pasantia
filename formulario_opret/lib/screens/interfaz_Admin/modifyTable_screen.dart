...
class _ModifyTableState extends State<ModifyTable> {
  ...
  final ApiServiceLineas _apiServiceLineas = ApiServiceLineas('http://sistemaencuestaopretapi.somee.com');
  late Future<List<Linea>> _lineaData;
  final ApiServiceEstacion _apiServiceEstacion = ApiServiceEstacion('http://sistemaencuestaopretapi.somee.com');
            ...
            TextButton(
              onPressed: () async {
                if (_formKey.currentState!.saveAndValidate()) {
                  ...
                  try{
                    final response = await ApiServiceLineas('http://sistemaencuestaopretapi.somee.com').postLinea(newLinea);
            ...
            TextButton(
              onPressed: () async {
                if (_formKey.currentState!.saveAndValidate()) {
                  ...
                  try{
                    final response = await ApiServiceLineas('http://sistemaencuestaopretapi.somee.com').putLinea(lineaUpload.idLinea, upLoadLinea);
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              ...
              onPressed: () async {
                try{
                  final response = await ApiServiceLineas('http://sistemaencuestaopretapi.somee.com').deleteLineas(lineaDelete.idLinea);
              ...
              TextButton(
                onPressed: () async {
                  if (_formKey.currentState!.saveAndValidate()) {
                    ...
                    Estacion? existingStation = await ApiServiceEstacion('http://sistemaencuestaopretapi.somee.com').getOneEstacion(newIdEstacion);
                    ...
                    try{
                      final response = await ApiServiceEstacion('http://sistemaencuestaopretapi.somee.com').postEstacion(newStation);
            ...
            TextButton(
              onPressed: () async {
                if (_formKey.currentState!.saveAndValidate()) {
                  ...
                  try{
                    final response = await ApiServiceEstacion('http://sistemaencuestaopretapi.somee.com').putEstacion(estacionUpload.idEstacion, stationUpload);
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              ...
              onPressed: () async {
                try{
                  final response = await ApiServiceEstacion('http://sistemaencuestaopretapi.somee.com').deleteEstacion(estacionDelete.idEstacion);
