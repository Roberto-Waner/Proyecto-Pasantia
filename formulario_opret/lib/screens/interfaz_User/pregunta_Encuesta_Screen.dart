...
class _PreguntaEncuestaScreenState extends State<PreguntaEncuestaScreen> {
  ...
  final ApiServiceRespuesta _apiRespuesta = ApiServiceRespuesta('https://10.0.2.2:7002');
      ...
      builder: (BuildContext context, ) {
        return StatefulBuilder(
          builder: (BuildContext context, StateSetter setState) {
            return AlertDialog(
              title: Text('Pregunta No: ${question.idPreguntas}. ${question.preguntas}'),
              content: FormBuilder(
                key: _formKey,
                child: Column(
                  ...
                  children: [
                    FormBuilderTextField(
                      ...
                      decoration: InputDecorations.inputDecoration(
                        hintext: '', 
                        labeltext: 'No. Respuesta', 
                        icono: const Icon(Icons.numbers_outlined)
                      ),
                    ),
