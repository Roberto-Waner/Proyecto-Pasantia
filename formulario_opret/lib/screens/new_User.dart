...
class _NewUserState extends State<NewUser> {
  ...
  String _selectedRole = 'Empleado'; // Valor inicial del Dropdown
      ...
      if(_selectedRole == 'Empleado'){
        ...
        try {
          ...
          if (response.statusCode == 201) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('Error al agregar usuario: ${response.reasonPhrase}')),
            );
          }
        } catch (e) {
          // Manejo de errores
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      width: double.infinity,
                      height: 950, //altura de la ventana "ventanaRegistro"
                      decoration: BoxDecoration(
                        color: const Color.fromRGBO(217, 217, 217, 1),
